...
import { ShieldCheck, HeartHandshake, GraduationCap, type LucideIcon } from 'lucide-react';
import FadeInSection from '@/components/planwise/FadeInSection';

const icons: Record<string, LucideIcon> = { ShieldCheck, HeartHandshake, GraduationCap };
const badgeClasses = [
...
export default function DifferentiatorCards() {
  const items = getDifferentiators();
  return (
